    ...
    $.fn.extend({
        ...
        venobox: function(options) {
            ...
            var defaults = {
                ...
                overlayClose: true, // disable overlay click-close
                ...
                spinColor : '#d2d2d2',
                titleattr: 'title', // specific attribute to get a title (e.g. [data-title])
                titleBackground: '#161617',
                titleColor: '#d2d2d2',
                titlePosition : 'top', // 'top' || 'bottom'
                cb_pre_open: function(){ return true; }, // Callbacks
